/**
* @file    021_glCoordinate.cpp
* <pre>
* Copyright (c) 2010-2018, Gaaagaa All rights reserved.
*
* 文件名称：021_glCoordinate.cpp
* 创建日期：2018年08月21日
* 文件标识：
...
int main(int argc, char * argv[])
{
	...
	GLFWwindow * window = glfwCreateWindow(WIDTH, HEIGHT, "LearnOpenGL - 021 - glCoordinate", NULL, NULL);
	if (NULL == window)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUseProgram(xshader.program_id());
		{
			...
			for (GLuint i = 0; i < 10; ++i)
			{
				...
				mtx4M = glm::rotate(mtx4M, glm::radians(i * 10.0F) + ((0 == (i % 3)) ? xtime : 0.0F), glm::vec3(1.0F, 0.3F, 0.5F));
