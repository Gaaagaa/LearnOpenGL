...
int main(int argc, char * argv[])
{
	...
	GLFWwindow * window = glfwCreateWindow(WIDTH, HEIGHT, "LearnOpenGL - 023 - glCamera", NULL, NULL);
	if (NULL == window)
	{
...
void key_callback(GLFWwindow * window, int key, int scancode, int action, int mode)
{
	...
	GLfloat cameraSpeed = (GLFW_REPEAT == action) ? 0.1F : 0.01F;
