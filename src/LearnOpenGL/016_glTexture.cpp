...
int main(int argc, char * argv[])
{
	...
	GLFWwindow * window = glfwCreateWindow(WIDTH, HEIGHT, "LearnOpenGL - 016 - glTexture", NULL, NULL);
	if (NULL == window)
	{
	...
	GLfloat vertices[] =
	{
		...
		-0.5F, -0.5F, 0.0F,    0.0F, 0.0F, 1.0F,   0.15F, 0.45F,
		-0.5F,  0.5F, 0.0F,    1.0F, 1.0F, 0.0F,   0.15F, 0.55F
	};
