/**
* @file    020_glCoordinate.cpp
* <pre>
* Copyright (c) 2010-2018, Gaaagaa All rights reserved.
*
* 文件名称：020_glCoordinate.cpp
* 创建日期：2018年08月21日
* 文件标识：
...
int main(int argc, char * argv[])
{
	...
	GLFWwindow * window = glfwCreateWindow(WIDTH, HEIGHT, "LearnOpenGL - 020 - glCoordinate", NULL, NULL);
	if (NULL == window)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, texture);
		glm::mat4 mtx4M = glm::rotate(mtxIdentity, (GLfloat)glfwGetTime(), glm::vec3(0.5F, 1.0F, 0.0F));
