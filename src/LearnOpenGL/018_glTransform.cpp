/**
* @file    018_glTransform.cpp
* <pre>
* Copyright (c) 2010-2018, Gaaagaa All rights reserved.
*
* 文件名称：018_glTransform.cpp
* 创建日期：2018年08月21日
* 文件标识：
* 文件摘要：LearnOpenGL 示例程序：变换。
*
* 当前版本：1.0.0.0
* 作    者：
* 完成日期：2018年08月21日
...
int main(int argc, char * argv[])
{
	...
	GLFWwindow * window = glfwCreateWindow(WIDTH, HEIGHT, "LearnOpenGL - 018 - glTransform", NULL, NULL);
	if (NULL == window)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUseProgram(xshader.program_id());
		{
			...
			glUniformMatrix4fv(glGetUniformLocation(xshader.program_id(), "transform"),
							   1,
							   GL_FALSE,
			...
			transform = glm::mat4(1.0F, 0.0F, 0.0F, 0.0F,
								  0.0F, 1.0F, 0.0F, 0.0F,
								  0.0F, 0.0F, 1.0F, 0.0F,
								  0.0F, 0.0F, 0.0F, 1.0F);
			transform = glm::translate(transform, glm::vec3(-0.5f, 0.5f, 0.0f));
			GLfloat scaleAmount = (sin(glfwGetTime()) + 1.0F) / 2;
